...
if __name__ == '__main__':
    ...
    if args.action == "train":
        train(args.algorithm, seed=args.seed, verbose=args.verbose, model=args.model, degree=args.degree)
    elif args.action == "visualize":
        visualize(args.algorithm, verbose=args.verbose, model=args.model)
